      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage your driver database and licenses
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("cell_number", e.target.value)
                      }
                    />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue
                          placeholder={
                            formData.license_code ?? "Select license code"
                          }
                        />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("pdp_expiry_date", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <CardContent className="flex items-center gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      ID: {selectedDriver.id_or_passport_number}
                    </p>
                  </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 text-wrap">
                      ...
                      <div>
                        ...
                        {selectedDriver.front_of_driver_pic ? (
                          <img
                            ...
                            className="mt-2 w-full max-w-[240px] rounded-lg border shadow-sm object-cover"
                          />
                        ) : (
                          <p className="text-sm text-gray-500 mt-1">
                            Not uploaded
