...
//     const { data: trailerData, error: trailerError } = await supabase.from("trailer").select("*");
//     if (trailerError) {
...
//           etaPickup:
//             pickupLocations?.[0]?.scheduled_time || trip.startdate || "",
//           etaDropoff:
//             dropoffLocations?.[0]?.scheduled_time || trip.enddate || "",
...
//         fuel_cost + base_cost + ppk_cost + standing_day_cost;
...
//       const cpk =
//         estimatedDistance > 0
//           ? costBreakdown.total_transport / estimatedDistance
//           : 0;
...
//     {
//       id: "a",
//       title: "VINCEMUS INVESTMENTS (P...)",
//       addr: "Johannesburg, South Africa",
//       addr2: "Estcourt, 3310, South Africa",
//     },
...
//                 ? vehicles.find((v) => v.id.toString() === selectedTrailerId)
//                     ?.registration_number || ""
//                 : "",
//             },
//           },
...
//                         <TableCell>
//                           {row.etaPickup
//                             ? row.etaPickup.includes("T")
//                               ? new Date(row.etaPickup).toLocaleString()
//                               : row.etaPickup
//                             : row.startdate || "-"}
//                         </TableCell>
//                         <TableCell>
//                           {row.etaDropoff
//                             ? row.etaDropoff.includes("T")
//                               ? new Date(row.etaDropoff).toLocaleString()
//                               : row.etaDropoff
//                             : row.enddate || "-"}
//                         </TableCell>
...
//                             <SelectItem key={index} value={trailerItem.id.toString()}>
...
//                                 value={tripDays}
//                                 onChange={(e) =>
//                                   setTripDays(parseFloat(e.target.value) || 1)
//                                 }
//                                 placeholder="1"
//                                 type="number"
//                                 step="0.5"
...
//                             R{totalVehicleCost.toLocaleString()}
//                           </p>
...
//                                 {
//                                   name: "Fuel",
//                                   value: approximateFuelCost,
//                                   fill: "url(#fuelGradient)",
//                                 },
//                                 {
//                                   name: "Vehicle",
//                                   value: approximatedVehicleCost,
...
//                   View and track optimized truck routes for all loads. Routes
//                   are automatically optimized considering truck restrictions,
//                   traffic conditions, and delivery schedules.
//                 </p>
//               </CardContent>
//             </Card>
