        ...
        <div className="flex justify-between items-center px-4 py-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="opacity-90 text-blue-100 text-sm">
                ...
                <div className="bg-yellow-50 p-4 border border-yellow-200 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-yellow-800 text-sm">
                      The following items are at or below the minimum threshold
                      of 10 units
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 p-4 border border-blue-200 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-blue-800 text-sm">
                      Consider placing orders for these items to maintain
