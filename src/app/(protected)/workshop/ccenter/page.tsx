  ...
  return (
    <div className="flex-1 space-y-4 p-4 pt-6">
      <div className="flex items-center justify-between">
        ...
        {/* <Dialog open={isCreateQuotationOpen} onOpenChange={setIsCreateQuotationOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Repair Type</DialogTitle>
      ...
      <Tabs defaultValue="quotations" className="space-y-4">
        <TabsList>
          <TabsTrigger value="quotations">All Repairs</TabsTrigger>
          <TabsTrigger value="pending">Pending Approval</TabsTrigger>
          <TabsTrigger value="pending-insepection">
            Pending Inspection
          </TabsTrigger>
        ...
        {/* add filter for type of repair statues */}
        {/* if older than five day we remove and we have were we can get all */}

        {["quotations", "approved", "pending", "pending-inspection"].map(
          (tab) => (
                    ...
                    .map((quotation) => (
                      <Card key={quotation.id}>
                        ...
                        <CardContent>
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                              <p className="text-sm font-medium">
                                Driver: {quotation.drivername || "N/A"}
                              </p>
                              <p className="text-sm font-medium">
                                Vehicle: {quotation.vehiclereg || "N/A"}
                              </p>
                              <p className="text-sm font-medium">
                                Job Type: {quotation.job_type || "N/A"}
                              </p>
                              <p className="text-sm font-medium">
                                Priority: {quotation.priority || "N/A"}
                              </p>
                            </div>
                            <div>
                              <p className="text-sm font-medium">
                            ...
                            <div>
                              <p className="text-sm font-medium">
                                Labor: R {(quotation.laborcost || 0).toFixed(2)}
                              </p>
                              <p className="text-sm font-medium">
                                Parts: R {(quotation.partscost || 0).toFixed(2)}
                              </p>
                          ...
                          {quotation.parts_needed &&
                            quotation.parts_needed.length > 0 && (
                              <div className="mb-4">
                            ...
                            >
                              ...
                              <DialogContent className="sm:max-w-lg">
                                <DialogHeader>
                                  ...
                                  <DialogDescription>
                                    Provide key details so we can schedule
                                    quickly.
                                  </DialogDescription>
                                </DialogHeader>
